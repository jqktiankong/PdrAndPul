...
public class PullableRecyclerView1 extends RecyclerView implements Pullable {
    ...
    public PullableRecyclerView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PullableRecyclerView1(Context context, @Nullable AttributeSet attrs, int defStyle) {
